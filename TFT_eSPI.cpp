...
#include "TFT_eSPI.h"
  ...
  #include "Processors/TFT_eSPI_RTduino.c"
#else
...
#if defined(ARDUINO_ARCH_RTTHREAD)
    spi.begin();

#elif !defined (ESP32) && !defined(TFT_PARALLEL_8_BIT) && !defined(ARDUINO_ARCH_RP2040) && !defined (ARDUINO_ARCH_MBED)
